<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="Bokado_In.index" %>
	     ...
	     <!--	<div class="hero-warp">
				<div class="main-search-form">
                   <div class="search-type">
					<div class="st-item">
							<input type="radio" name="st" id="sell" checked>
							<label for="sell">Buy</label>
						</div>
					 <div class="st-item">
