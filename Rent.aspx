<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Rent.aspx.cs" Inherits="Bokado_In.Rent" %>
  ...
  <div class="col-lg-4">
   <div class="container">
    <div class="card" style="width:400px">
       <a href="rentDetail.aspx?id=<%#Eval("rid") %>"><img class="card-img-top" src='<%#Eval("pic")%>' alt="Card image" style="width:100%; height:300px"/></a>
        <div class="card-body">
         <h4 class="card-title">FOR RENT</h4>
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></div>
    ...
    <script type="text/javascript">
        function search()
        {
            window.location = "Rent.aspx?search=" + document.getElementById("searchtextbox").value;
        }
    </script>
