<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminSignUp.aspx.cs" Inherits="Bokado_In.AdminSignUp" %>
			...
			<div class="wrap-login100 p-l-50 p-r-50 p-t-77 p-b-30" style="background: #696969;">
				<div class="login100-form validate-form">
					...
					<div class="container-login100-form-btn p-t-25">
                        <asp:Button ID="Button1" runat="server" Text="Admin Signup" class="login100-form-btn" style="background: red;" OnClick="Button1_Click"/>
